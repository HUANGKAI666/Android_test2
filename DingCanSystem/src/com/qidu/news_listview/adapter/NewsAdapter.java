package com.qidu.news_listview.adapter;

import java.util.ArrayList;

import com.yanruqi.CatersSystem.R;
import com.qidu.news_listview.bean.NewsBean;
import com.qidu.news_listview.view.MyImageView;
...
//			view =  LayoutInflater.from(context).inflate(R.layout.item_news_layout, null);
		...
		case 0:
			item_tv_type.setText("美食头条");
			break;
		case 1:
			item_tv_type.setText("头条");
			break;
		case 2:
			item_tv_type.setText("玩乐");
			break;
		default:
			break;
		}
